...
- PR activo de revisión: [#278](https://github.com/jdlc86/gestionpisos/pull/278). Sustituye a #276/#277 únicamente para obtener CI sobre el HEAD final generado por el conector; ambos anteriores quedan cerrados sin merge.
...
- Siguiente acción exacta: comprobar los tres checks del HEAD final de PR #278, revisar hilos y diff final, fusionar solo si todo está verde, verificar despliegue post-merge y ejecutar E2E humano antes de marcar WF-04 `VERIFIED`. Solo ChatGPT puede autorizar WF-05.
