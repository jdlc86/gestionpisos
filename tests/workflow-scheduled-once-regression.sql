  ...
  (
    ...
    from public.update_unexecuted_workflow_v2(
      ...
      jsonb_build_object(
        ...
        'triggerType','scheduled_once',
        'recurrence','',
        'scheduledAt',to_char(date_trunc('minute',now()+interval '15 minutes') at time zone 'UTC','YYYY-MM-DD"T"HH24:MI'),
        'scheduledTimezone','UTC',
        'scheduledAtUtc',to_char(date_trunc('minute',now()+interval '15 minutes') at time zone 'UTC','YYYY-MM-DD"T"HH24:MI:SS"Z"'),
        'customEvery','',
        'customUnit','',
        'assignmentType','manual',
        'steps',jsonb_build_object('accept',true,'photo',false,'checklist',false,'document',false),
  ...
  (
    ...
    from public.publish_workflow_ready_v2(
      jsonb_build_object(
        ...
        'triggerType','scheduled_once',
        'recurrence','',
        'scheduledAt',to_char(date_trunc('minute',now()+interval '30 minutes') at time zone 'UTC','YYYY-MM-DD"T"HH24:MI'),
        'scheduledTimezone','UTC',
        'scheduledAtUtc',to_char(date_trunc('minute',now()+interval '30 minutes') at time zone 'UTC','YYYY-MM-DD"T"HH24:MI:SS"Z"'),
        'customEvery','',
        'customUnit','',
        'assignmentType','property_responsible',
        'steps',jsonb_build_object('accept',true,'photo',false,'checklist',false,'document',false),
