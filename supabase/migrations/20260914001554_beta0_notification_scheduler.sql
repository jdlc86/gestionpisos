...
revoke all on function private.process_due_notifications() from public, anon, authenticated;

select cron.schedule(
  'gestionpisos-notification-dispatch',
  '*/5 * * * *',
  'select private.process_due_notifications();'
);
