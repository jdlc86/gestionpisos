...
begin
 ...
 select * into v_action from public.tenant_task_actions_v2
  where task_id=p_task_id and action_key=p_action_key and from_status=v_task.status and active=true;
