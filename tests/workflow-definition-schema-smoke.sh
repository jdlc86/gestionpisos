...
grep -Fq "drop policy if exists tenant_task_actions_v2_workflow_manager_read" "$human_review"
grep -Fq "tenant_task_actions_v2.actor='assignee'" "$human_review"
grep -Fq "tenant_task_actions_v2.actor='agency'" "$human_review"
