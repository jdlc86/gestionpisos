-- Align responsible assignment with the single administrative write-control authority.
-- Keep the existing atomic assignment/audit behavior while narrowing RPC exposure.
...
revoke execute on function public.assign_property_responsible_v3(uuid,uuid) from public;
