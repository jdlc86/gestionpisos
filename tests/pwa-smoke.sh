...
grep -q '__allaisoReferenceDisplayMaskCanvas' docs/photo-reference-guide.js
grep -q 'const maxSide = 720' docs/photo-reference-guide.js
grep -q 'globalAlpha = 0.72' docs/photo-reference-guide.js
