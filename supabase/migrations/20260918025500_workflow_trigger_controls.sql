-- GestionPisos · Flujos de Trabajo · controles condicionales de activacion
-- Riesgo R3: persiste parametros dependientes del tipo de activacion y evita campos irrelevantes.
...
comment on function public.save_workflow_definition_draft_v1(jsonb, uuid, bigint) is
  'Guarda borradores con activacion saneada: frecuencia solo para recurrente, fecha/hora solo para fecha concreta y cadencia adicional solo para recurrencia personalizada. Los guardados sin cambios siguen siendo idempotentes.';
